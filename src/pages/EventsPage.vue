  ...
  <q-layout>
    <q-pull-to-refresh @refresh="refresh">
      ...
      <div
        ...
        :style="{
          marginTop: Screen.gt.sm ? '-60px' : null,
        }"
      >
        <q-btn-group rounded>
      ...
      <q-page-sticky position="top-right" :offset="[18, 18]" v-if="store.user?.role === 'leader'">
...
import {
  date, Loading, LoadingBar, Notify, Screen,
} from 'quasar';
